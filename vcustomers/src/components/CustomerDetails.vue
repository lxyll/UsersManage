<template>
  <div class="details container">
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item">
        <span class="glyphicon glyphicon-list-alt"> {{customer.graduationschool}}</span>
      </li>

      <li class="list-group-item">
        <span class="glyphicon glyphicon-info-sign"> {{customer.profession}}</span>
      </li>
      <li class="list-group-item">
        <span class="glyphicon glyphicon-duplicate"> {{customer.profile}}</span>
      </li>
    </ul>
  </div>
</template>
